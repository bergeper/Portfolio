...
export const repos: Repo[] = [
  new Repo(
    ...
    Working with my team members, we ensured the webshop was visually appealing 
    and easy to navigate. Overall, it was a great opportunity to apply our skills 
  ...
  new Repo(
    ...
    The project was simple yet provided a strong foundation for future course projects.
    `,
...
// Omdb Desktop -> https://dl.dropboxusercontent.com/s/pxff6hes2yjmfyu/OmdbDesk.png?dl=0
// Omdb Mobile -> https://dl.dropboxusercontent.com/s/2i3hs10rsxssc5w/OmdbMobile.png?dl=0
// Todo Desktop -> https://dl.dropboxusercontent.com/s/maanc6hhe4zdruc/TShirtDesk.png?dl=0
// Todo Mobile -> https://dl.dropboxusercontent.com/s/tzvyvozguozqc9u/TodoMobile.png?dl=0
